...
public class MyPluginForMyBatis {
    public static void main(String[] args) {
        // build("com.test.mytest.chenva", "mapper", "entity", "mapper\\xml", false);
    ...
    public static void build(String pack, boolean flag) {
        build(pack, "dao", "model", "dao\\mapper", flag);
    }
     ...
     * com.test.cmodel.model.CModel.java
     */
    public static void build(String pack, String dao, String model, String mapper, boolean flag) {
